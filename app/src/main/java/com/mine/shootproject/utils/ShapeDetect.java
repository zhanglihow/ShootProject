...
public class ShapeDetect {
    ...
    public static int[] shapeDetcte(Mat mRgba){
...
//    }
    ...
    public static int[] return_shape_num(int san,int rect,int lin,int star,int yuan){
    ...
    public static Mat yanse(Mat mask,int i){
