...
public class ColorBlobDetectionActivity2 extends CameraActivity implements OnTouchListener, CvCameraViewListener2 {
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    mOpenCvCameraView.setOnTouchListener(ColorBlobDetectionActivity2.this);
                } break;
                default:
                {
